...
# Use a regex pattern to match elements with ids starting with "facs_13"
regex_pattern = re.compile(r'#facs_13\S*')

# Extract the specified elements based on the regex pattern
...
# Append the extracted elements inside the tei_root after the facsimile element
