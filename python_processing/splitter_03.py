...
# Define the namespaces including the 'tei' and 'xml' namespaces
namespaces = {
...
# Find all 'surface' elements with xml:id="facs_13"
...
# Append the extracted elements inside the proper structure
# Create <text>, <body>, and <div> elements
...
# Write the XML string with the updated elements and correct namespace prefix
with io.StringIO() as string_io:
    tei_tree.write(string_io, encoding='unicode', xml_declaration=True)
    tei_str = re.sub(r'\bns0:', 'tei:', string_io.getvalue())  # Replace ns0 with tei
